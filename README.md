...
```
    Как читатель, я хочу взять книгу в один клик, чтобы начать читать без лишних шагов.
    Как читатель, я хочу встать в очередь на книгу, если она занята, и получить уведомнение о свободном издании.
    Как читатель, я хочу видеть все взятые книги в одном месте.
    Как читатель, я хочу читать книгу прямо в приложении, чтобы не использовать сторонние сервисы.

    Как библиотекарь, я хочу добавлять и удалять лицензии на книги, чтобы управлять коллекцией.
    Как библиотекарь, я хочу видеть статистику выдач и популярности, чтобы развивать фонд.

    Как admin, я хочу модерировать отзывы и управлять библиотеками, чтобы поддерживать качество платформы.
```
